...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="dashboard()">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden" x-data="{ activeTab: 'works' }">
        ...
        <div class="flex border-b border-gray-200 bg-gray-50">
            <button @click="activeTab = 'works'" :class="{'border-b-2 border-blue-500 text-blue-600 font-medium': activeTab === 'works'}" class="px-6 py-4 text-gray-600 hover:text-gray-800 focus:outline-none transition duration-150 ease-in-out">
            ...
            <button @click="activeTab = 'lessons'" :class="{'border-b-2 border-blue-500 text-blue-600 font-medium': activeTab === 'lessons'}" class="px-6 py-4 text-gray-600 hover:text-gray-800 focus:outline-none transition duration-150 ease-in-out">
                <span class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
